...
```{r deltaSelectiveAdvantage, echo = FALSE, message = FALSE, fig.height = 4, fig.width = 9, fig.align='center'}
...
```{r BA1selectiveAdvantage, echo = FALSE, message = FALSE, fig.height = 4, fig.width = 9, fig.align='center'}
...
```{r BA2selectiveAdvantage, echo = FALSE, message = FALSE, fig.height = 4, fig.width = 9, fig.align='center'}
