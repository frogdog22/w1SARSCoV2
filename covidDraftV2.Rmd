...
```{r BA.2frequencyTrajectory, fig.height = 11, fig.width = 11, fig.align='center', echo = FALSE, message = FALSE}
...
```{r deltaSelectiveAdvantage, echo = FALSE, message = FALSE, fig.height = 5, fig.width = 10, fig.align='center'}
...
```{r BA1selectiveAdvantage, echo = FALSE, message = FALSE, fig.height = 5, fig.width = 10, fig.align='center'}
...
```{r BA2selectiveAdvantage, echo = FALSE, message = FALSE, fig.height = 5, fig.width = 10, fig.align='center'}
...
```{r logisticModel, fig.align = "center"}
...
ggplot(deltaPositive, aes(x = collection_date_bin, y = lineage_frequency)) +
  ...
  labs(title = "Delta Frequencies and  by Region", # Labels the title and axes
       x = "Collection date", 
       y = "Frequency") +
  theme_minimal()
```
...
```{r parameterPlots, fig.width = 11, fig.height = 5, fig.align='center'}
...
```{r calculateAndPlotIncidence, message = FALSE, warning = FALSE, fig.align='center', fig.width = 7, fig.height = 5}
library(tidyverse)
...
```{r Rt, fig.height = 5, message = FALSE, warning = FALSE, fig.width = 10, fig.align='center'}
